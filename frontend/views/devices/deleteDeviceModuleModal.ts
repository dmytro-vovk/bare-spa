...
export default class DeleteDeviceModuleModal extends ModalWithForm {
	...
	constructor(private readonly app: App) {
		super({
			modal: "#delete-device-module-modal",
			form:  "#delete-device-module-form",
		});
	...
	private async handleModalOpen(event: MouseEvent): Promise<void> {
		...
		$$("#delete-device-module-name").innerText = this.module.name;
	}
	...
	private deleteModule(req: { deviceID: number, moduleID: number }): void {
		this.app.call("devices.deleteModule", req)
